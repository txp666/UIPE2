...
void setup_scr_screen_menu(lv_ui *ui)
{
    ...
    //Write codes screen_menu_btn_menu_mqtt
    ui->screen_menu_btn_menu_mqtt = lv_btn_create(ui->screen_menu);
    ui->screen_menu_btn_menu_mqtt_label = lv_label_create(ui->screen_menu_btn_menu_mqtt);
    lv_label_set_text(ui->screen_menu_btn_menu_mqtt_label, " " LV_SYMBOL_GPS " ");
    lv_label_set_long_mode(ui->screen_menu_btn_menu_mqtt_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_menu_btn_menu_mqtt_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_menu_btn_menu_mqtt, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_menu_btn_menu_mqtt_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_menu_btn_menu_mqtt, 186, 130);
    lv_obj_set_size(ui->screen_menu_btn_menu_mqtt, 100, 100);

    //Write style for screen_menu_btn_menu_mqtt, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_menu_btn_menu_mqtt, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_menu_btn_menu_mqtt, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_menu_btn_menu_mqtt, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_menu_btn_menu_mqtt, lv_color_hex(0x5482a9), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_menu_btn_menu_mqtt, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_menu_btn_menu_mqtt, 25, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_menu_btn_menu_mqtt, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_menu_btn_menu_mqtt, lv_color_hex(0x12548b), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_menu_btn_menu_mqtt, &lv_font_montserratMedium_50, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_menu_btn_menu_mqtt, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_menu_btn_menu_mqtt, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
