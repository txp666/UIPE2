...
void lv_port_disp_init(SCREEN_CLASS *scr)
{
    ...
    */
    ...
    // lv_color_t *buf_3_1 = (lv_color_t *)heap_caps_malloc(DISP_HOR_RES * DISP_VER_RES, MALLOC_CAP_SPIRAM);
    // lv_color_t *buf_3_2 = (lv_color_t *)heap_caps_malloc(DISP_HOR_RES * DISP_VER_RES, MALLOC_CAP_SPIRAM);
    // lv_disp_draw_buf_init(&draw_buf_dsc_3, buf_3_1, buf_3_2, DISP_VER_RES * DISP_HOR_RES);
